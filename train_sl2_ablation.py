...
class TrainClassifier:
    ...
    def train(self, **kwargs):
        ...
        trainloader = DataLoader(train_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)

        valloader = DataLoader(test_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)

        testloader = DataLoader(test_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)
	
        train_eval_loader = DataLoader(train_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)

        val_eval_loader = DataLoader(test_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)

        test_eval_loader = DataLoader(test_features_dataset, batch_size=batch_size, shuffle=True, pin_memory=False)
